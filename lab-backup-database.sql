...
INSERT INTO dev.orders (orderID,userName,orderType,purchaseDate) VALUES (1,'aaron','laptop','2018-02-23'),(2,'stosh','desktop','2018-01-25'),(3,'kenny','server','2019-12-10'),(4,'mike','tablet','2019-04-22'),(5,'myles','2019-05-15');
...
INSERT INTO test.orders (orderID,userName,orderType,purchaseDate) VALUES (1,'aaron','laptop','2018-02-23'),(2,'stosh','desktop','2018-01-25'),(3,'kenny','server','2019-12-10'),(4,'mike','tablet','2019-04-22'),(5,'myles','2019-05-15');
...
INSERT INTO prod.orders (orderID,userName,orderType,purchaseDate) VALUES (1,'aaron','laptop','2018-02-23'),(2,'stosh','desktop','2018-01-25'),(3,'kenny','server','2019-12-10'),(4,'mike','tablet','2019-04-22'),(5,'myles','2019-05-15');
